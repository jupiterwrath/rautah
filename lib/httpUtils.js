module.exports = {
  code: require(appRoot + '/codepacks/codeUtil.js'),
  ...
  filters: function(req){
    var blk = require(appRoot + '/conf/block.json'),
        ste = require(appRoot + '/conf/sites.json'),
        chk = 0;
  ...
  makeLog: function(log, msg){
    ...
    switch(log){
      ...
      case 2: log = 'access';
        break;
    } file.appendFile(appRoot + '/logs/'+log+'.log', (msg + "\n"), function(err){
        if(err) throw err;
        console.log(msg);
      });
  },
